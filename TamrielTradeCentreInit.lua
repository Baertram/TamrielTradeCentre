...
function TamrielTradeCentre:NPCNameToKioskID(npcNameString, isExact)
	...
	if (npcNameString == nil or npcNameString == "") then
		return nil
	end
...
function TamrielTradeCentre_MasterWritInfo:New(itemLink)
	...
	local _, _, requiredItemName = string.find(masterWritDescription, requiredItemNameRegex)
...
function TamrielTradeCentre_AutoRecordEntry:New(itemLink, amount, totalPrice, expireTime)
